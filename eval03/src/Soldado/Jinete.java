 ...
 */
public class Jinete extends Soldado {
    ...
    public Jinete(int movimiento, int vida, int ataque, int defensa) {
    ...
    @Override
    public void Vida() {
        System.out.println("La vida de este jinete es: " + this.vida);
    }

    @Override
    public void Mover() {
        System.out.println("Este jinete tiene velocidad de movimiento : " + this.movimiento );
    }
